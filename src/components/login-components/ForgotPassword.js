                      ...
                      <form className="theme-form">
                        <div className="form-group">
                          ...
                          <div className="input-block">
                            <input type="text" className={`form-control ${userData.mobile.length === 10 && 'border border-success rounded-3'}`} placeholder="Enter Mobile Number" onChange={(e) => { setUserData({ ...userData, mobile: e.target.value }); errorRef.current.classList.add('d-none') }} onKeyPress={numberFilter}/>
