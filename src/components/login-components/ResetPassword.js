                      ...
                      <form className="theme-form">
                        <div className="form-group">
                          ...
                          <div className="input-block">
                            <input type={passwordShown ? "text" : "password"} className={`form-control ${error && 'border-danger'}`}  placeholder="Enter password" onChange={(e) => { setPassword({ ...password, new: e.target.value });setError(''); errorRef.current.classList.add('d-none') }} maxLength={25}/>
                        ...
                        <div className="form-group">
                          ...
                          <div className="input-block">
                            <input type={passwordShown2 ? "text" : "password"} className={`form-control ${error && 'border-danger'}`} placeholder="Confirm Password" onChange={(e) => { setPassword({ ...password, confirm: e.target.value });setError(''); errorRef.current.classList.add('d-none') }} maxLength={25}/>
