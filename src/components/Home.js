                        ...
                        <div className="page-content">
                            ...
                            <div className="content-center">
                                ...
                                <div className="post-panel section-t-space">
                                    ...
                                    >
                                        {
                                            allUserPosts?.rows && allUserPosts?.rows.map((userPosts) => {
                                                return (
                                                    <div className="post-wrapper col-grid-box mt-4" key={userPosts.postId}>
                                                        {
                                                            userPosts?.postType === 'suggestedBusiness' && <SuggestedBizPage bizPage={userPosts} />
                                                        }
                                                        {
                                                            userPosts?.postType === 'suggestedGroups' && <SuggestedGroup groups={userPosts} />
                                                        }
                                                        {
                                                            userPosts?.postType === 'suggestedAd' && <SuggestedAd ad={userPosts.adData} />
                                                        }
