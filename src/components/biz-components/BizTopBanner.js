    ...
    return (
        <>
            <div className="group-details-top biz-details-top">
                <div className="gd-top-block" style={{ background: `url(${process.env.REACT_APP_IMAGEURL + bizPage?.bpResponse?.bpCoverImages[0]?.coverUrl || 'assets/images/bizcover.jpg'})` }}>
                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-4 col-lg-4 col-12 order-lg-2">
                            <div className="biz-user-pro-blk">
                                <img src={process.env.REACT_APP_IMAGEURL + bizPage?.bpResponse?.logo} />
                        ...
                        <div className="col-xl-4 col-lg-4 col-12 order-lg-1">
                            <div className="gd-content-area-top-blk">
                                <div className="groupmember-blk">
                                    <span><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="iw-10 ih-10"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg> Public Group</span> • <span>{bizPage?.bpResponse?.bpCategory?.name}</span>
                                </div>
                                <div className="people-likes matual-friend-sec">
                                    <ul className="matual-friend-blk">
                                        {
                                            bizPage?.bpResponse?.bpVisitors?.map((visitors) => {
                                                return <li className="popover-cls" data-bs-toggle="popover">
                                                    <img src={visitors?.user?.profileImage} className="img-fluid bg-img" alt="" />
                                                </li>
                                            })
                                        }

                                    </ul>
                                    <h6>+{bizPage?.bpResponse?.bpVisitors?.length} Visited today</h6>
                                </div>
                                <div className="people-likes matual-friend-sec">
                                    <ul className="matual-friend-blk">
                        ...
                        <div className="col-xl-4 col-lg-4 col-12 order-lg-3">
                            <ul className="followlist-blk">
                                <li>{bizPage?.bpResponse?.averageRating || 0}<span>Rating</span></li>
                                <li>42k<span>Likes</span></li>
                                <li>52<span>Posts</span></li>
                                <li>{bizPage?.followerCount}<span>Followers</span></li>
